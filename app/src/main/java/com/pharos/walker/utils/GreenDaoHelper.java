...
import com.pharos.walker.greendao.DaoMaster;
...
public class GreenDaoHelper {
    ...
    public static void initDatabase() {
        ...
        mHelper = new MyOpenHelper(MyApplication.getInstance(), "Walker.db", null);
        db = mHelper.getWritableDatabase();
        // 注意：该数据库连接属于 DaoMaster，所以多个 Session 指的是相同的数据库连接。
        mDaoMaster = new DaoMaster(db);
//        mDaoSession = mDaoMaster.newSession(IdentityScopeType.None);//解决更新缓存问题
        mDaoSession = mDaoMaster.newSession();//解决更新缓存问题
    }
    ...
    public static class MyOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            },  UserBeanDao.class, PlanEntityDao.class, SubPlanEntityDao.class, UserTrainRecordEntityDao.class, EvaluateEntityDao.class,
                    TrainDataEntityDao.class, ActivationCodeBeanDao.class, LocalDoctorNameBeanDao.class, BLeDeviceInfoBeanDao.class,
                    OriginalSubPlanEntityDao.class,OriginalSubPlanEntityDao.class,
                    OtherFeedbackBeanDao.class);
        }
    }
    public static final class MigrationHelper {
