...
/** 
 * DAO for table "ORIGINAL_TRAIN_PLAN".
*/
public class OriginalPlanEntityDao extends AbstractDao<OriginalPlanEntity, Long> {

    public static final String TABLENAME = "ORIGINAL_TRAIN_PLAN";

    /**
     * Properties of entity OriginalPlanEntity.<br/>
    ...
    public OriginalPlanEntityDao(DaoConfig config) {
        super(config);
    }
    
    public OriginalPlanEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORIGINAL_TRAIN_PLAN\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORIGINAL_TRAIN_PLAN_KEY_ID ON \"ORIGINAL_TRAIN_PLAN\"" +
                " (\"KEY_ID\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORIGINAL_TRAIN_PLAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, OriginalPlanEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, OriginalPlanEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public OriginalPlanEntity readEntity(Cursor cursor, int offset) {
        OriginalPlanEntity entity = new OriginalPlanEntity( //
    ...
    @Override
    public void readEntity(Cursor cursor, OriginalPlanEntity entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(OriginalPlanEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(OriginalPlanEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(OriginalPlanEntity entity) {
