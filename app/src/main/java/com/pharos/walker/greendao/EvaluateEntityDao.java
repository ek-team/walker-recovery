...
public class EvaluateEntityDao extends AbstractDao<EvaluateEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FourthValue = new Property(10, float.class, "fourthValue", false, "FOURTH_VALUE");
        public final static Property FifthValue = new Property(11, float.class, "fifthValue", false, "FIFTH_VALUE");
        public final static Property IsUpload = new Property(12, int.class, "isUpload", false, "IS_UPLOAD");
        public final static Property RecordPath = new Property(13, String.class, "recordPath", false, "RECORD_PATH");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EVALUATE_VALUE\" (" + //
                ...
                "\"FOURTH_VALUE\" REAL NOT NULL ," + // 10: fourthValue
                "\"FIFTH_VALUE\" REAL NOT NULL ," + // 11: fifthValue
                "\"IS_UPLOAD\" INTEGER NOT NULL ," + // 12: isUpload
                "\"RECORD_PATH\" TEXT);"); // 13: recordPath
        // Add Indexes
    ...
    protected final void bindValues(DatabaseStatement stmt, EvaluateEntity entity) {
        ...
        stmt.bindDouble(11, entity.getFourthValue());
        stmt.bindDouble(12, entity.getFifthValue());
        stmt.bindLong(13, entity.getIsUpload());
 
        String recordPath = entity.getRecordPath();
        if (recordPath != null) {
            stmt.bindString(14, recordPath);
        }
    }
    ...
    public EvaluateEntity readEntity(Cursor cursor, int offset) {
        EvaluateEntity entity = new EvaluateEntity( //
            ...
            cursor.getFloat(offset + 10), // fourthValue
            cursor.getFloat(offset + 11), // fifthValue
            cursor.getInt(offset + 12), // isUpload
            cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13) // recordPath
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, EvaluateEntity entity, int offset) {
        ...
        entity.setFourthValue(cursor.getFloat(offset + 10));
        entity.setFifthValue(cursor.getFloat(offset + 11));
        entity.setIsUpload(cursor.getInt(offset + 12));
        entity.setRecordPath(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
     }
