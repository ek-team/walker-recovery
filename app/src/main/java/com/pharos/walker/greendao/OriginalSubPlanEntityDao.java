...
/** 
 * DAO for table "ORIGINAL_SUB_TRAIN_PLAN".
*/
public class OriginalSubPlanEntityDao extends AbstractDao<OriginalSubPlanEntity, Long> {

    public static final String TABLENAME = "ORIGINAL_SUB_TRAIN_PLAN";

    /**
     * Properties of entity OriginalSubPlanEntity.<br/>
    ...
    public OriginalSubPlanEntityDao(DaoConfig config) {
        super(config);
    }
    
    public OriginalSubPlanEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORIGINAL_SUB_TRAIN_PLAN\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORIGINAL_SUB_TRAIN_PLAN_KEY_ID ON \"ORIGINAL_SUB_TRAIN_PLAN\"" +
                " (\"KEY_ID\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORIGINAL_SUB_TRAIN_PLAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, OriginalSubPlanEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, OriginalSubPlanEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public OriginalSubPlanEntity readEntity(Cursor cursor, int offset) {
        OriginalSubPlanEntity entity = new OriginalSubPlanEntity( //
    ...
    @Override
    public void readEntity(Cursor cursor, OriginalSubPlanEntity entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(OriginalSubPlanEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(OriginalSubPlanEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(OriginalSubPlanEntity entity) {
