...
@Entity(nameInDb = "ORIGINAL_SUB_TRAIN_PLAN")
public class OriginalSubPlanEntity {
    @Id
    private Long id;                 //ID
    ...
    @Generated(hash = 767066919)
    public OriginalSubPlanEntity(Long id, long userId, long keyId, long planId,
    ...
    @Generated(hash = 487898480)
    public OriginalSubPlanEntity() {
    }
    public Long getId() {
        return this.id;
    }
