...
@Entity(nameInDb = "ORIGINAL_TRAIN_PLAN")
public class OriginalPlanEntity {
    @Id
    private Long id;                 //ID
    ...
    @Transient
    private List<OriginalSubPlanEntity> subPlanEntityList;

    public List<OriginalSubPlanEntity> getSubPlanEntityList() {
        return subPlanEntityList;
    }

    public void setSubPlanEntityList(List<OriginalSubPlanEntity> subPlanEntityList) {
        this.subPlanEntityList = subPlanEntityList;
    }

    @Generated(hash = 355033256)
    public OriginalPlanEntity(Long id, long userId, long keyId, long planId,
            int planType, String createDate, String updateDate, String weight,
            int planTotalDay, int classId, int planStatus, String startDate,
            String endDate, int timeOfDay, int countOfTime, int load, int trainTime,
            int trainType, String str, String remark) {
        this.id = id;
        this.userId = userId;
        this.keyId = keyId;
        this.planId = planId;
    ...
    @Generated(hash = 1090070690)
    public OriginalPlanEntity() {
    }
    public Long getId() {
        return this.id;
    }
