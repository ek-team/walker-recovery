...
public class UserBean implements Parcelable {
    ...
    private int cardType;//0身份证号，1病历号
    @Transient
    private String macAdd;      // 设备Id
    private String idCard;      // 身份证号
    private String height;//身高
    private String educationLevel;//文化程度
    private String doctorTeam;//医生团队
    private int doctorTeamId;//医生团队Id
    private String  treatmentMethodId;//治疗方法Id
    private String bodyPartName;//手术部位
    private String secondDiseaseName;//疾病名称
    private int userType;      // //0骨科用户，1康复科用户
    @Generated(hash = 1292136015)
    public UserBean(Long id, long userId, long keyId, @NotNull String name,
            @NotNull String caseHistoryNo, int age, String date, int sex,
            @NotNull String diagnosis, String photo, String doctor,
            String hospitalName, String hospitalAddress, String address,
            String telephone, String linkman, String pingYin, String createDate,
            String updateDate, String remark, @NotNull String weight,
            float evaluateWeight, String account, String password, String str,
            int isUpload, int isFirstRun, int isRecordUpdate,
            String diseaseDiagnosis, int cardType, String idCard, String height,
            String educationLevel, String doctorTeam, int doctorTeamId,
            String treatmentMethodId, String bodyPartName, String secondDiseaseName,
            int userType) {
        this.id = id;
        this.userId = userId;
        this.keyId = keyId;
        ...
        this.secondDiseaseName = secondDiseaseName;
    ...
    public void setDoctorTeamId(int doctorTeamId) {
        this.doctorTeamId = doctorTeamId;
    }
    ...
    public String getSecondDiseaseName() {
        return this.secondDiseaseName;
    }
    public void setSecondDiseaseName(String secondDiseaseName) {
        this.secondDiseaseName = secondDiseaseName;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.diseaseDiagnosis);
        dest.writeInt(this.cardType);
        dest.writeString(this.macAdd);
        dest.writeString(this.idCard);
        dest.writeString(this.height);
        dest.writeString(this.educationLevel);
        dest.writeString(this.doctorTeam);
        dest.writeInt(this.doctorTeamId);
        dest.writeString(this.treatmentMethodId);
        dest.writeString(this.bodyPartName);
        dest.writeString(this.secondDiseaseName);
    ...
    protected UserBean(Parcel in) {
        ...
        this.diseaseDiagnosis = in.readString();
        this.cardType = in.readInt();
        this.macAdd = in.readString();
        this.idCard = in.readString();
        this.height = in.readString();
        this.educationLevel = in.readString();
        this.doctorTeam = in.readString();
        this.doctorTeamId = in.readInt();
        this.treatmentMethodId = in.readString();
        this.bodyPartName = in.readString();
        this.secondDiseaseName = in.readString();
