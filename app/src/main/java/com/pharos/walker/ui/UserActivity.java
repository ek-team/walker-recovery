...
//                    SPHelper.saveUser(userBean);
                    ...
                    intent1.putExtra("userId",userBean.getUserId());
        ...
        dialog.setSureListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userBean.getUserId() == SPHelper.getUserId()){
                    SPHelper.saveUser(UserManager.getInstance().loadGuest());
                    Global.USER_MODE = false;
                    setHeader();
                }
                dialog.dismiss();
...
//        mAdapter.setData(mUserManager.loadAll());
    ...
    private void resetScanUser(){
        OkHttpUtils.deleteAsyncToken(Api.deletePlatformQrScanUser  +  codeBean.getMacAddress() , new OkHttpUtils.DataCallBack() {
            @Override
            public void requestFailure(Request request, IOException e) {
                e.printStackTrace();
            }
