...
public class PrintContentActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        if (evaluateEntity != null){
            ...
            fourthValue = evaluateEntity.getFourthValue();
            fifthValue = evaluateEntity.getFifthValue();
        }
    }
    ...
    private void initView() {
        ...
        tvTitle.setText("负重康复评定/步态分析报告单");
        ...
        tvEvaluateValue.setText(MessageFormat.format("{0}kg", result));
        tvVas.setText(MessageFormat.format("VAS={0}", vasValue));
...
//        intent.setType("image/*");
    ...
    private void saveRecordAsPdf(){
        ...
        try {
            path = file1.getAbsolutePath() + File.separator + DateFormatUtil.getDate2String(System.currentTimeMillis(),"yyyy-MM-dd HH.mm.ss") + "_评估报告" + ".pdf";
            File e = new File(path);
            if (e.exists()) {
                e.delete();
            }
