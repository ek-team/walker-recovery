package com.pharos.walker.customview.bubble;
...
import static com.pharos.walker.customview.bubble.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.pharos.walker.customview.bubble.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.pharos.walker.customview.bubble.BubbleSeekBar.TextPosition.SIDES;
import static com.pharos.walker.customview.bubble.BubbleUtils.dp2px;
import static com.pharos.walker.customview.bubble.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        drawMark = a.getBoolean(R.styleable.BubbleSeekBar_bsb_marks, true);
        String colorStr = a.getString(R.styleable.BubbleSeekBar_bsb_colors);
        if (colorStr == null || colorStr.equals("")) {
            colorStr = "#FF00FF00_#FFFFFF00_#FFFF0000";
        }
    ...
    public void setThumbEvent(boolean event) {
        isEvent = event;
    }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = dp2px(20); // default 14dp
    ...
    public void setSelectTextColor(@ColorInt int selectTextColor) {
        if (mSectionTextColor != selectTextColor) {
            mSectionTextColor = selectTextColor;
            invalidate();
        }
    }
    ...
    private class BubbleView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            setMeasuredDimension(4 * mBubbleRadius, 4 * mBubbleRadius);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float y0 = getMeasuredHeight() - mBubbleRadius / 3f - 20;
            ...
            canvas.drawText(mProgressText, getMeasuredWidth() / 2f , baseline + 2, mBubblePaint);
        }
